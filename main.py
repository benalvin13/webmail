...
def first():
    if request.method == 'POST':
        ...
        sender_email = "info@feventsmanagement.com"
        sender_emaill = "info"
        receiver_email = "benalvin13@gmail.com"
        password = "INcorrect@1981"
        ...
        with smtplib.SMTP_SSL("mail.feventsmanagement.com", 465) as server:
